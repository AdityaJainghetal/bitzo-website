...
// // import { Menu, Search, Mic, Plus, Bell, Star } from 'lucide-react';
// // import { useRewards } from '../../context/RewardContext'; // ← import this (from previous setup)

// // export default function Navbar({ toggleSidebar }) {
// //   const { points } = useRewards(); // Get current points from global context
...
// //             {/* Points display – starts at 70, increases on watch */}
...
// //             <span className="text-white text-sm font-semibold">A</span> {/* Changed to A for Aditya */}
// //           </div>
// //         </div>
// //       </div>
// //     </header>
...
//   // Mock logged-in state (in real app use auth context)
