...
//     description:
//       "This is a sample video. Upload your first video to get started!",
//     thumbnail:
...
//     description: "Learn how to use this platform effectively.",
//     thumbnail:
//       "https://images.unsplash.com/photo-1542744094-3a31f272c490?w=800&h=450&fit=crop",
//     videofile: "",
//     videoUrl: "",
//     views: 0,
//     duration: "0:00",
...
//     description: "Useful tips to make the most of your channel.",
//     thumbnail:
...
//     "https://images.unsplash.com/photo-1557683316-973673baf926?w=1600&h=400&fit=crop",
//   channeldescription:
//     "Welcome to my channel! Start by creating your first channel and uploading videos.",
//   category: { _id: "1", name: "General" },
//   subscribers: 0,
//   isOwnChannel: true,
//   avatar:
//     "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop",
...
//         const res = await fetch(API_CATEGORY);
//         if (!res.ok) {
//           console.log("Failed to fetch categories, using static data");
//           setCategories(STATIC_CATEGORIES);
//           return;
//         }
//         const data = await res.json();
//         setCategories(data && data.length > 0 ? data : STATIC_CATEGORIES);
//       } catch (error) {
//         console.error("Error fetching categories:", error);
//         setCategories(STATIC_CATEGORIES);
//       }
...
//       if (!userId || !token) {
//         console.log("No user or token, using static channel");
//         const staticChannelKey = "MyChannel";
//         setChannels({
//           [staticChannelKey]: {
//             ...STATIC_CHANNEL,
//             handle: `@${staticChannelKey}`,
//           },
//         });
//         setSelectedHandle(staticChannelKey);
//         setLoading(false);
//         return;
//       }
...
//         if (!res.ok) {
//           console.log("Failed to fetch channels, using static data");
//           const staticChannelKey = "MyChannel";
//           setChannels({
//             [staticChannelKey]: {
//               ...STATIC_CHANNEL,
...
//           console.log("No channels found, using static data");
//           const staticChannelKey = "MyChannel";
//           setChannels({
//             [staticChannelKey]: {
//               ...STATIC_CHANNEL,
...
//           // Skip API call for static channel
//           if (channelId.startsWith("static_")) {
//             setChannel({
//               ...channels[cleanHandle],
//               videos: STATIC_VIDEOS,
//               videosCount: STATIC_VIDEOS.length,
//             });
//             navigate(`/channel/${cleanHandle}`, { replace: true });
//             return;
//           }
...
//           const finalVideos =
//             videosData.length > 0 ? videosData : STATIC_VIDEOS;
...
//           subscribers: data.subscribers || 0,
//           videosCount: data.videos?.length || 0,
//           videos: data.videos || STATIC_VIDEOS,
//           description: data.channeldescription || "More about this channel...",
//           categoryId: data.category,
//         };
...
//       if (channelId.startsWith("static_")) {
//         alert("Please create a real channel first to upload videos.");
//         setUploading(false);
//         return;
//       }
...
//   const handlePlayVideo = (video) => {
//     if (video._id.startsWith("static")) {
//       alert(
//         "This is a placeholder video. Upload your own videos to watch them here!",
//       );
//       return;
//     }
//     setCurrentVideo(video);
...
// Static fallback data (only used in extreme cases)
const STATIC_CATEGORIES = [
  { _id: "1", name: "Gaming" },
  { _id: "2", name: "Education" },
  { _id: "3", name: "Entertainment" },
...
export default function ChannelPage() {
  ...
  const [channels, setChannels] = useState([]); // array of channels
  const [selectedChannelId, setSelectedChannelId] = useState(null);
  const [channel, setChannel] = useState(null); // currently viewed channel
  const [categories, setCategories] = useState([]);
